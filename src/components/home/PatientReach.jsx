        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-gray-500 text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
              Patna Gastro, Lapro &amp; Stone Healthcare has become a premier surgical destination. Patients from Nepal, Jharkhand, Uttar Pradesh (UP), and all 38 districts of Bihar travel to our Patna clinic for specialized care under <strong className="text-navy-800 font-bold">Dr. Sanjeev Kumar</strong>.
            </p>
          </motion.div>
        </div>
