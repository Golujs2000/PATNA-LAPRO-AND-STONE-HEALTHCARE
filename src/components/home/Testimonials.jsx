...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    date: '4 months ago',
    text: 'Dr. Sanjeev Kumar is one of the best gastro surgeons in Patna, Bihar. He successfully performed laparoscopic gallstone surgery on my 70-year-old mother. She recovered very well, within two days of the surgery, and was discharged on the third day. The hospital staff and nursing sisters were extremely caring, supportive, and professional. Overall, the experience was excellent. Dr. Sanjeev Kumar is truly the best surgeon in Bihar. Highly recommended!',
    initials: 'AP',
    verified: true,
  },
  {
    ...
    rating: 5,
    date: '4 months ago',
    text: 'We consulted Dr. Sanjeev Kumar gastro surgeon in Patna for a case of stone with pancreatitis and jaundice. The doctor diagnosed the problem accurately and explained everything in a very clear and reassuring manner. ERCP was performed successfully, and the patient improved significantly after the procedure. The hospital staff were supportive, caring, and maintained good cleanliness. Post-procedure care and guidance were excellent. He has two centres in Patna: Chirayu Health Care, Kidwaipuri (Krishnanagar) and Medimax Hospital. Best ERCP doctor in Bihar.',
    initials: 'NB',
    verified: true,
  },
  {
    ...
    rating: 5,
    date: '4 months ago',
    text: 'Dr. Sanjeev Kumar, GI Surgeon and top gastroenterologist of Patna, Bihar, made an accurate and timely diagnosis of Koch’s abdomen with cysticercosis, which saved the patient’s life. He is highly experienced and trustworthy. We are truly grateful for his care.',
    initials: 'NY',
    verified: true,
  },
  {
