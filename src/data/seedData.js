...
export const seedDoctors = [
  {
    ...
    specialty: 'Laparoscopic & Stone Surgeon',
    qualification: 'MBBS, MS, DNB',
    experience: 20,
    bio: 'Dr. Sanjeev Kumar (MBBS, MS, DNB) is the founder and chief surgeon at Patna Lapro and Stone Healthcare, L-35, Road No. 12, Sri Krishna Nagar Kidwaipuri, Patna. A highly experienced laparoscopic and stone surgeon, he is currently serving as Sr. Consultant at Medimax Hospital and previously served as Surgeon at VMMC College & Safdarjung Hospital, New Delhi. He is a specialist in Jaundice, Stone diseases, Pancreas & Liver disorders.',
    image: '',
    ...
    specializations: ['Laparoscopic Surgery', 'Kidney Stone', 'Gallbladder Stone', 'Liver Disorders', 'Pancreas Disorders', 'Jaundice & Biliary', 'Hernia', 'Gastrointestinal Surgery'],
    currentPosition: 'Sr. Consultant, Medimax Hospital, Patna',
    previousPosition: 'Ex-Surgeon, VMMC College & Safdarjung Hospital, New Delhi',
    rating: 4.9,
    reviewCount: 350,
    featured: true,
  },
...
export const seedBlogs = [
  ...
  },
  {
    ...
    image: '',
    tags: ['kidney stones', 'PCNL', 'ureteroscopy', 'stone surgery Patna', 'Dr Sanjeev Kumar'],
    published: true,
    views: 0,
  },
  {
...
export const seedHospitalServices = [
  ...
  },
  {
    ...
    category: 'Consultation',
    available: '24 Hours',
    description: 'Consult with Dr. Sanjeev Kumar via video or phone call. Share reports and scans for expert surgical opinion from the comfort of your home.',
    relatedSpecialties: [],
    order: 2,
  },
  {
