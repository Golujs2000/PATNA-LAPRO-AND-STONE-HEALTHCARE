  ...
  return (
    <>
      <SEO
        ...
        description="Book a surgical appointment at Patna Gastro, Lapro and Stone Healthcare, Patna online. Choose your department, select a date, and our team confirms within 30 minutes. Consultation by appointment."
        keywords={['book surgery appointment Patna', 'online laparoscopy booking Patna', 'kidney stone doctor appointment Patna', 'Patna Gastro, Lapro and Stone Healthcare appointment']}
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'ReserveAction',
          name: 'Book an Appointment at Patna Gastro, Lapro and Stone Healthcare',
          target: {
            '@type': 'EntryPoint',
